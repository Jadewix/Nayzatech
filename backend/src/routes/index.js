  ...
  sendSuccess(res, {
    ...
    endpoints: {
      ...
      public: {
        ...
        'GET    /api/products/:id/availability': 'Whether one product can be ordered',
        'POST   /api/orders': 'Place an order (checkout) — phone number required',
        'POST   /api/orders/check-availability': 'Pre-checkout availability + delivery fee',
      ...
      admin: {
        ...
        'PATCH  /api/admin/orders/:id/status': 'Move through the lifecycle',
        'POST   /api/admin/orders/:id/delivery-attempt': 'Log a failed courier visit without ending the order',
